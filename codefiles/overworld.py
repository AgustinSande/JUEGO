...
class Icon(pygame.sprite.Sprite):
    ...
    def __init__(self, pos):
        super().__init__()
        self.pos = pos
        self.image = pygame.image.load(".//JUEGO 2//graphics//overworld//hat.png").convert_alpha()
...
class Node(pygame.sprite.Sprite):
    ...
    def update(self):
        if self.status == "unlocked":
            ...
            tinted_surface.fill(C_BLACK, None, pygame.BLEND_RGBA_MULT)
...
class Overworld:
    ...
    def draw_paths(self):
        if self.max_level > 0:
            ...
            pygame.draw.lines(self.display_surface, C_PEACH, False,points, 10)
